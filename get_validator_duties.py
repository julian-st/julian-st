...
def main(validators_indices, eth2_api_url="http://localhost/eth/v1/"):
    ...
    epoch = epoch + 2
    cur_epoch_data = api_post(f"validator/duties/attester/{epoch}", json.dumps(validators_indices))["data"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("indices", metavar="index", type=str, nargs="+", help="validator indices")
